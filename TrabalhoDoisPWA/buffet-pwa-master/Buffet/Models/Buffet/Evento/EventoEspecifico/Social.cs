...
{
    public class Social: EventoGenerico
    {
        ...
        public Social(string descricao, DateTime novoInicio, DateTime novoTermino, Local novoLocal, string novasObservacoes, DateTime momentoInsercao, DateTime novaModificacao, SituacaoGeralEvento novaSituacao) : base(descricao)
        {
            Inicio = novoInicio;
            Termino = novoTermino;
            Local = novoLocal;
