...
{
    public class Aniversario: EventoGenerico
    {
        ...
        public Aniversario(string descricao, DateTime novoInicio,DateTime novoTermino,Local novoLocal,string novasObservacoes,DateTime momentoInsercao,DateTime novaModificacao,SituacaoGeralEvento novaSituacao):base(descricao)
        {
            Inicio = novoInicio;
            Termino = novoTermino;
            Local = novoLocal;
